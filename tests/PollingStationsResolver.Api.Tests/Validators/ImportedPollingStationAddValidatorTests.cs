...
public class ImportedPollingStationAddValidatorTests
{
    private readonly Validator _validator;

    public ImportedPollingStationAddValidatorTests()
    {
    ...
    {
        var request = new AddImportedPollingStationRequest() { Latitude = latitude };
    ...
    {
        var request = new AddImportedPollingStationRequest() { Longitude = longitude };
        var result = _validator.TestValidate(request);
    ...
    {
        var request = new AddImportedPollingStationRequest() { County = county };
        var result = _validator.TestValidate(request);
    ...
    {
        var request = new AddImportedPollingStationRequest() { Locality = locality };
        var result = _validator.TestValidate(request);
    ...
    {
        var request = new AddImportedPollingStationRequest() { PollingStationNumber = pollingStationNumber };
        var result = _validator.TestValidate(request);
    ...
    {
        var request = new AddImportedPollingStationRequest() { Address = address };
        var result = _validator.TestValidate(request);
    ...
    {
        var request = new AddImportedPollingStationRequest
        {
            Locality = "locality",
            Address = "address",
            County = "county",
