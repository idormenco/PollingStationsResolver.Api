...
public static class PaginationHelper
{
    ...
    public static int CalculateTake(Pagination pagination)
    {
        return CalculateTake(pagination.PageSize);
    }
    public static int CalculateSkip(Pagination pagination)
    {
        return CalculateSkip(pagination.PageSize, pagination.Page);
    }
}